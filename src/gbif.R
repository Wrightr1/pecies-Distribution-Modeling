...
# https://www.gbif.org/occurrence/download/0012245-240202131308920
#Most downloads finish within 15 min.
#Check status with
#occ_download_wait('0012245-240202131308920')
...
#Format: SIMPLE_CSV
#Download key: 0012245-240202131308920
#Created: 2024-02-13T20:29:36.297+00:00
#Citation Info:  
#Please always cite the download DOI when using this data.
#https://www.gbif.org/citation-guidelines
#DOI: 10.15468/dl.73a88w
#Citation:
#GBIF Occurrence Download https://doi.org/10.15468/dl.73a88w Accessed from R via rgbif (https://github.com/ropensci/rgbif) on 2024-02-13

d <- occ_download_get('0012245-240202131308920', path="data/") %>%
  occ_download_import()
